...
Figures~\ref{fig:DiffLDiffStudy_AvDiff_RMS} and~\ref{fig:DiffLDiffStudy_AvDiff_RMS_Int} show the effect that different constants of longitudianl diffusion have on the accuracy to which the interaction time, and central $x$ position of a track, can be determined. \\
